...
class MyCircularQueue:
    ...
    def __init__(self, k: int):
        ...
        self.capacity = k
        self.contained = 0
        print(f"CREATED QUEUE: {self.queue} @ {self.contained}/{self.capacity}")
    ...
    def Front(self) -> int:
        ...
        self.dump(f"FRONT: {self.queue.value}")
    ...
    def Rear(self) -> int:
        ...
        self.dump(f"REAR: {self.queue.prev.value}")
